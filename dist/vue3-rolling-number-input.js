import { defineComponent as V, reactive as N, ref as A, computed as h, watch as w, openBlock as g, createElementBlock as I, Fragment as B, renderList as G, normalizeClass as z, createElementVNode as n, toDisplayString as k, withDirectives as p, vModelCheckbox as M, vModelText as f, createVNode as D } from "vue";
const Y = { class: "rolling-number-input-grid" }, S = ["value", "onKeydown", "onInput", "onWheel"], J = ["name", "value"], P = /* @__PURE__ */ V({
  ...
  setup(d, { emit: i }) {
    ...
    const v = async (e, l) => {
      ...
      if (e.key === "ArrowUp") {
        await m(!0, l), e.preventDefault();
        return;
      }
      if (e.key === "ArrowDown") {
        await m(!1, l), e.preventDefault();
        return;
      }
      if (s >= 0 && s <= 9)
        return;
      ...
      e.deltaY < 0 ? await m(!0, l) : e.deltaY > 0 && await m(!1, l);
    }, m = async (e, l) => {
    ...
    return (e, l) => (g(), I("span", Y, [
      (g(!0), I(B, null, G(o.value, (u, s) => (g(), I("input", {
        ref_for: !0,
        ref_key: "inputs",
        ref: r,
        key: s,
